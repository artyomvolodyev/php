...
var pathToImages = ImagesPathforJs;//'../images/';	// Relative to your HTML file
...
var selectBoxHighlightColor = '#c36'; // Highlight color of select boxes
var selectBoxRolloverBgColor = '#51c6e8'; // Background color on drop down lists(rollover)
