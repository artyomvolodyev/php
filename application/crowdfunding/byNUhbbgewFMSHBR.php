...
exit; // WE DO NOT ALLOW ACCESS TO THIS FILE DUE TO SECURITY CONSIDERATIONS
...
/*
 ...
 'user'=>"teematic_tee",#required

 'pwd'=>"7xGs5PaE7m4MGIeh", #required

 'db'=>"teematic_tee",  #optional, default DB
